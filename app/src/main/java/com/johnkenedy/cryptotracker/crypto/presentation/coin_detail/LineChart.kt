...
import com.johnkenedy.cryptotracker.ui.theme.lineChartAreaGradient
import com.johnkenedy.cryptotracker.ui.theme.lineChartGradient
...
fun LineChart(
    ...
    Canvas(
        ...
        drawPath(
            path = fillPath,
            brush = colorScheme.lineChartAreaGradient(
                startY = viewPortTopY,
        ...
        drawPoints.forEachIndexed { index, point ->
            if (isShowingDataPoints) {
                ...
                // Small white inner circle (per the reference image)
                drawCircle(
                    color = Color.White,
                    radius = 5f,
                    center = circleOffset
...
private fun LineChartPreview() {
    CryptoTrackerTheme {
        ...
        val style = ChartStyle(
            chartLineColor = MaterialTheme.colorScheme.lineChartGradient,
